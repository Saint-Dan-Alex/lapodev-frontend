...
export default function JoinPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Simuler un temps de traitement pour le "Wow effect"
            ...
            <AnimatePresence mode="wait">
                {submitted ? (
                    <motion.div
                        ...
                        className="flex flex-col pt-32 pb-20"
                    >
                        <div className="container mx-auto px-4 text-center">
                            <div className="max-w-md mx-auto bg-white p-12 rounded-[3rem] shadow-2xl border border-slate-100 flex flex-col items-center">
                                <motion.div
                                    ...
                                    className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center text-green-600 mb-8"
                                >
                    ...
                    >
                        ...
                        <div className="container mx-auto px-4 md:px-8 max-w-5xl pb-20">
